...
enum Items {
	...
	CHICKEN_LEG, STEAK_RAW, HAM_BONE, MEAT_RIB, FISH_FILLET, EGGS_BASKET, EGG_SINGLE, CHEESE_WEDGE, MILK_BOTTLE, HONEY_POT, FLOUR_BAG, SPICE_BAG, CANDY, CAKE_SLICE, COFFEE_MUG,
...
const FOODS: Array[Items] = [
	...
	Items.CHICKEN_LEG, Items.STEAK_RAW, Items.HAM_BONE, Items.MEAT_RIB, Items.EGGS_BASKET, Items.EGG_SINGLE, Items.CHEESE_WEDGE, Items.MILK_BOTTLE, Items.HONEY_POT, Items.CANDY, Items.CAKE_SLICE,
...
const REGION_LOCATION: Dictionary[Items, Vector2i] = {
	...
	Items.CHICKEN_LEG: Vector2i(0, 15), Items.STEAK_RAW: Vector2i(1, 15), Items.HAM_BONE: Vector2i(2, 15), Items.MEAT_RIB: Vector2i(3, 15), Items.FISH_FILLET: Vector2i(4, 15), Items.EGGS_BASKET: Vector2i(5, 15), Items.EGG_SINGLE: Vector2i(6, 15), Items.CHEESE_WEDGE: Vector2i(7, 15), Items.MILK_BOTTLE: Vector2i(8, 15), Items.HONEY_POT: Vector2i(9, 15), Items.FLOUR_BAG: Vector2i(10, 15), Items.SPICE_BAG: Vector2i(11, 15), Items.CANDY: Vector2i(12, 15), Items.CAKE_SLICE: Vector2i(13, 15), Items.COFFEE_MUG: Vector2i(14, 15),
