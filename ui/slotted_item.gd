...
enum Items {
	...
	BOOK_BLUE, BOOK_RED, BOOK_GREEN, BOOK_YELLOW, BOOK_BLACK, BOOK_BROWN, BOOK_OPEN_BLUE, BOOK_OPEN_RED, BOOK_READING, ENVELOPE, SCROLL_TIED, PAPER_DOCUMENT, TREASURE_MAP, DICE, PLAYING_CARD_ACE, WINE_BOTTLE,
