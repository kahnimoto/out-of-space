...
const WEAPONS: Array[Items] = [
	...
	Items.BOW, Items.CROSSBOW, Items.SLINGSHOT, Items.BOOMERANG, Items.STAFF_GNARLED, Items.STAFF_BLUE, Items.STAFF_RED, Items.STAFF_GREEN, Items.STAFF_YELLOW,  Items.BLUE_SPELLBOOK, Items.RED_SPELLBOOK,
]
...
const FOODS: Array[Items] = [
	...
	Items.FISH_BROWN, Items.EEL, Items.FISH_YELLOW, Items.CLOWNFISH, Items.JELLYFISH
]
